...
app.post("/status/:id_transaksi", (request, response) => {
    // tampung nilai status data
    let data = {
        status: request.body.status
    }
    

    // kita tampung paramater 
    let parameter = {
        id_transaksi: request.params.id_transaksi
    } 
...
//  end point untk mengubah status pembayaran 
...
module.exports = app
// tampung data untuk insert ke tabel transaksi 
    // tampung paramater id_transaksi 
    // setelah berhasil insert ke tabel transaksi
    // data detail transaksi yang lama di di hapus semua berdasarkan 
    // id_transaksinya
